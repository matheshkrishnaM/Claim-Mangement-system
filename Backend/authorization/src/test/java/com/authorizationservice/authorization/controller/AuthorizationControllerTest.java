...
class AuthorizationControllerTest {
	...
	void testValidLogin() throws LoginException {
		AuthenticationRequestDTO authenticationRequestDTO = new AuthenticationRequestDTO("Hari", "Hari");
		UserDetails userDetails = new User(authenticationRequestDTO.getUsername(), authenticationRequestDTO.getPassword(),
				new ArrayList<>());

		when(appUserDetailsService.loadUserByUsername("Hari")).thenReturn(userDetails);
	...
	void testInvalidLogin() {
		AuthenticationRequestDTO authenticationRequestDTO = new AuthenticationRequestDTO("Hari", "Shajitha");
		UserDetails userDetails = new User(authenticationRequestDTO.getUsername(), "Hari", new ArrayList<>());
	...
	void testValidToken() {
		...
		when(jwtUtil.extractUsername("token")).thenReturn("Hari");
		when(appUserDetailsService.loadUserByUsername("Hari")).thenReturn(userDetails);
